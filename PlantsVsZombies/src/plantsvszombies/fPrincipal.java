...
public class fPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bIniciar.setBounds(160, 460, 73, 23);
        getContentPane().add(tfY);
        tfY.setBounds(223, 400, 30, 20);
        getContentPane().add(tfX);
        tfX.setBounds(140, 400, 30, 20);
    ...
    private void bZombiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bZombiesActionPerformed
        ...
        fJugadores catalogo = new fJugadores("zombies");
        catalogo.setVisible(true);
    }//GEN-LAST:event_bZombiesActionPerformed

    private void bIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIniciarActionPerformed
        // TODO add your handling code here:
        fEscenario escenario = new fEscenario(Integer.parseInt(tfX.getText()), Integer.parseInt(tfY.getText()));
